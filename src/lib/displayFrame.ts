 ...
 */
export function getFrameDecorations(frameId: DisplayFrameId, width: number, height: number): FrameDecoration[] {
  if (frameId === 'wall-led') {
  ...
  return [
    ...
    { x: width * 0.42, y: height * 0.8, width: width * 0.16, height: height * 0.14, fill: STAND_FILL },
    { x: width * 0.2, y: height * 0.94, width: width * 0.6, height: height * 0.06, fill: STAND_FILL },
  ];
}
